...
using input_X = InputDescriptor<Number, offsetof(Wiring, input_X)>;
using input_Y = InputDescriptor<Number, offsetof(Wiring, input_Y)>;

using output_SUM = OutputDescriptor<Number, offsetof(Wiring, output_SUM), offsetof(Storage, output_SUM), 0>;
...
//-----------------------------------------------------------------------------
// xod/core/if_else implementation
//-----------------------------------------------------------------------------
namespace xod__core__if_else {
...
using input_COND = InputDescriptor<Logic, offsetof(Wiring, input_COND)>;
using input_T = InputDescriptor<Number, offsetof(Wiring, input_T)>;
using input_F = InputDescriptor<Number, offsetof(Wiring, input_F)>;

using output_R = OutputDescriptor<Number, offsetof(Wiring, output_R), offsetof(Storage, output_R), 0>;
...
namespace xod {
    ...
    // Storage of #5 xod/core/constant_boolean
    xod__core__constant_boolean::Storage storage_5 = {
        { }, // state
        true // output_VAL
    };

    // Storage of #6 xod/core/add
    xod__core__add::Storage storage_6 = {
        { }, // state
        0 // output_SUM
    };

    // Storage of #7 xod/core/greater
    xod__core__greater::Storage storage_7 = {
        { }, // state
        false // output_GT
    };

    // Storage of #8 xod/core/if_else
    xod__core__if_else::Storage storage_8 = {
        { }, // state
        0 // output_R
    };
    ...
    const xod__core__add::Wiring wiring_6 PROGMEM = {
        ...
        { NodeId(0),
            ...
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_X
        { NodeId(1),
            xod__core__constant_number::output_VAL::INDEX,
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_Y
        // outputs (NodeId list binding)
        outLinks_6_SUM // output_SUM
    };
    ...
    const xod__core__greater::Wiring wiring_7 PROGMEM = {
        ...
        { NodeId(6),
            ...
            xod__core__add::output_SUM::STORAGE_OFFSET }, // input_LHS
        { NodeId(2),
            xod__core__constant_number::output_VAL::INDEX,
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_RHS
        // outputs (NodeId list binding)
        outLinks_7_GT // output_GT
    };
    ...
    const xod__core__if_else::Wiring wiring_8 PROGMEM = {
        ...
        { NodeId(7),
            ...
            xod__core__greater::output_GT::STORAGE_OFFSET }, // input_COND
        { NodeId(3),
            xod__core__constant_number::output_VAL::INDEX,
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_T
        { NodeId(4),
            xod__core__constant_number::output_VAL::INDEX,
            xod__core__constant_number::output_VAL::STORAGE_OFFSET }, // input_F
        // outputs (NodeId list binding)
        outLinks_8_R // output_R
    };
    ...
    const xod__core__digital_output::Wiring wiring_9 PROGMEM = {
        ...
        { NodeId(8),
            ...
            xod__core__if_else::output_R::STORAGE_OFFSET }, // input_PORT
        { NodeId(5),
            xod__core__constant_boolean::output_VAL::INDEX,
            xod__core__constant_boolean::output_VAL::STORAGE_OFFSET }, // input_SIG
        // outputs (NodeId list binding)
    };
